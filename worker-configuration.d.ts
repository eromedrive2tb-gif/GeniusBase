/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 68bb6bf29c14670c8198423b2f69bcab)
// Runtime types generated with workerd@1.20260305.0 2024-04-01 
declare namespace Cloudflare {
    interface GlobalProps {
        mainModule: typeof import("./Root/Engine/src/index");
        durableNamespaces: "RealtimeState";
    }
    interface Env {
        ...
        DB: D1Database;
        NODE_ENV: string;
        /** JWT secret used exclusively for Dashboard admin tokens (adminAuth middleware) */
        ADMIN_JWT_SECRET: string;
        /** JWT secret used exclusively for End-User and Service tokens (apiKeyAuth middleware) */
        ENDUSER_JWT_SECRET: string;
        REALTIME_STATE: DurableObjectNamespace<import("./Root/Engine/src/index").RealtimeState>;
        DASHBOARD_RPC_STATE: DurableObjectNamespace<import("./Root/Engine/src/index").DashboardRPCState>;
    }
}
